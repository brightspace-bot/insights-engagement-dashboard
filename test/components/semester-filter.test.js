	...
	describe('render', () => {
		it('should render semesters', async() => {
			const expectedFilterData = [
				{ id: '10007', displayName: 'IPSIS Semester New: 10007', selected: false },
				{ id: '121194', displayName: 'Fall Test Semester: 121194', selected: false },
				{ id: '120127', displayName: 'IPSIS Test Semester 1: 120127', selected: false }
			];
