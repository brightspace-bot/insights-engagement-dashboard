...
describe('d2l-insights-tree-selector-node', () => {
	...
	describe('accessibility', () => {
		...
		it('should pass all axe tests with nesting', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node
				name="top"
				data-id="1234"
				openable
				open
	...
	describe('render', () => {
		...
		it('should render with a dropdown control if openable', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" openable></d2l-insights-tree-selector-node>`);
		...
		it('should render as open if specified', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" openable open></d2l-insights-tree-selector-node>`);
	...
	describe('events', () => {
		...
		it('should fire d2l-insights-tree-selector-node-select on selection', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" data-id="321"></d2l-insights-tree-selector-node>`);
			await expectEvent('d2l-insights-tree-selector-node-select', el, () => getCheckbox(el).simulateClick(), {
				id: 321,
				isSelected: true
			});
		});
		...
		it('should fire d2l-insights-tree-selector-change on deselection', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" selected-state="explicit" data-id="23"></d2l-insights-tree-selector-node>`);
			await expectEvent('d2l-insights-tree-selector-node-select', el, () => getCheckbox(el).simulateClick(), {
				id: 23,
				isSelected: false
			});
		...
		it('should fire d2l-insights-tree-selector-change on selection from indeterminate', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" selected-state="indeterminate" data-id="1"></d2l-insights-tree-selector-node>`);
			await expectEvent('d2l-insights-tree-selector-node-select', el, () => getCheckbox(el).simulateClick(), {
				id: 1,
				isSelected: true
			});
		...
		it('should fire d2l-insights-tree-selector-node-open on open click when closed', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" data-id="9" openable></d2l-insights-tree-selector-node>`);
			await expectEvent('d2l-insights-tree-selector-node-open', el, () => getOpenControl(el).click(), {
				id: 9,
				isOpen: true
			});
		});

		it('should fire d2l-insights-tree-selector-node-open on open click when open', async() => {
			const el = await fixture(html`<d2l-insights-tree-selector-node name="node" data-id="8" openable open></d2l-insights-tree-selector-node>`);
			await expectEvent('d2l-insights-tree-selector-node-open', el, () => getOpenControl(el).click(), {
				id: 8,
				isOpen: false
			});
