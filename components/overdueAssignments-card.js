...
class OverdueAssignmentsCard extends Localizer(MobxLitElement) {
	...
	render() {
		return html`
			<d2l-labs-summary-card id="d2l-insights-engagement-overdueAssignments" .data="${this.data}" card-title="${this._cardTitle}" card-value="${this._cardValue}" card-message="${this._cardMessage}"></d2l-labs-summary-card>
		`;
	}
}
customElements.define('d2l-insights-overdueassignments-card', OverdueAssignmentsCard);
