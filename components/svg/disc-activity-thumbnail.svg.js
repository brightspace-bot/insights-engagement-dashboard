...
class DiscActivityThumbnailSvg extends Localizer(LitElement) {
	render() {
		const title = this.truncateString(this.localize('components.insights-discussion-activity-card.cardTitle'), 40);
		return html`
			<svg xmlns="http://www.w3.org/2000/svg" width="293" height="150" viewBox="0 0 291 150">
				<g id="Discussion">
					...
					<text id="Status_of_Assignment" transform="translate(21 12)" fill="#494c4e"
