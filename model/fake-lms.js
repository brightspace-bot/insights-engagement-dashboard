...
export async function fetchData({ roleIds, semesterIds, orgUnitIds, defaultView = false }) {
	const demoData = {
		records: [
			[1, 100, 500, 1, 33, 1000, 1593827361219],
			[1, 200, 600, 0, 33, 2000, null],
			[1, 300, 500, 1, null, 1000, null],
			[2, 200, 700, 1, 42, 4000, 1593827361219],
			[2, 300, 700, 0, 3, 0, null],
			[2, 400, 700, 0, 100, 7200, 1200000000000],
			[2, 500, 700, 0, 88, 4000, 1593827361219],
			[8, 200, 700, 0, null, 0, Date.now() - 100],
			[6, 600, 700, 0, 25, 2000, null]
		],
		orgUnits: [
			[1, 'Course 1', 3, [3, 4]],
			[2, 'Course 2', 3, [3, 10]],
