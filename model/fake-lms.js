...
export async function fetchData({ roleIds, semesterIds, orgUnitIds, defaultView = false }) {
	const demoData = {
		records: [
			...
			[1, 500, 500, 0, 65, 5000, null],
			[1, 500, 600, 0, 51, 4000, null],
			[2, 100, 500, 0, 60, 1100, null],
			[2, 200, 700, 1, 38, 4000, null],
			[1, 200, 700, 1, 71, 4000, null],
			[1, 100, 700, 1, 81, 1000, null],
			[2, 100, 700, 1, 91, 1200, null],
			[2, 300, 500, 0, 9, 7200, null],
		...
		users: [ // some of which are out of order
			...
			[500,  'ETest', 'EStudent', 'EStudent', null],
			[600,  'GTest', 'GStudent', 'GStudent', null],
			[700,  'FTest', 'FStudent', 'FStudent', null],
			[800,  'HTest', 'HStudent', 'HStudent', null],
			[900,  'ITest', 'IStudent', 'IStudent', null],
			[1000, 'KTest', 'KStudent', 'KStudent', null],
